...
export default function BlogEdit({ postId }) {
  ...
  const handleSave = async (publish = false) => {
    ...
    try {
      ...
      const method = 'PUT';
      const resp = await fetch(`${API}/api/admin/blog/${postId}`, { method, headers: { 'Content-Type': 'application/json' }, credentials: 'include', body: JSON.stringify(payload) });
