  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
        <h2 className="text-xl md:text-2xl font-semibold">My Addresses</h2>
        <button
          onClick={() => openForm(null)}
          className="w-full sm:w-auto px-4 py-2 bg-red-500 text-white rounded hover:bg-green-600"
        >
          Add Address
        </button>
      </div>
      {/* inline form */}
      {formOpen && (
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg w-full max-w-lg mb-6">
