...
export async function generateMetadata() {
  const [title, storeName] = await Promise.all([siteTitle('Contact Us'), getStoreName()]);
  return {
    title,
    ...
    openGraph: {
      ...
      description: 'Reach our support team for help with orders, returns, and product queries.',
      type: 'website',
    },
  };
}
