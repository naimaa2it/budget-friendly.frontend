...
export async function generateMetadata() {
  const [title, storeName] = await Promise.all([siteTitle('Privacy Policy'), getStoreName()]);
  return {
    title,
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <h1 className="text-3xl font-bold mb-6">Privacy Policy</h1>
        <p>{storeName} (&quot;we&quot;, &quot;us&quot;) is committed to protecting your personal information. This policy explains what data we collect, how we use it, and your rights.</p>
        <section>
