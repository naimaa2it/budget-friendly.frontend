      ...
      <div className="bg-white rounded-lg p-0 relative z-10 w-full max-w-md overflow-hidden shadow-xl">
        ...
        {view === 'email-register' && (
          <form onSubmit={handleEmailRegister} className="space-y-3">
            ...
            <div className="flex gap-2">
              <button type="submit" disabled={isLoading || isLockedOut} className="bg-gray-700 hover:bg-gray-800 text-white px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-opacity">
                {isLoading && (
        ...
        {view === 'email-login' && (
          <form onSubmit={handleEmailLogin} className="space-y-3">
            ...
            <div>
              <input required type="email" placeholder="Email address" value={email} onChange={e => setEmail(e.target.value)} className="w-full border border-gray-200 bg-white text-gray-900 placeholder-gray-400 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-100" disabled={isLoading || isLockedOut} />
            </div>
            <div className="relative">
              <input
                required
            ...
            <div className="flex gap-2">
              ...
              <button type="button" onClick={() => { clearMessages(); setView('email-register'); }} disabled={isLoading || isLockedOut} className="px-4 py-2 text-gray-700 hover:bg-gray-50 rounded disabled:opacity-50 transition-opacity">Register</button>
            </div>
            <div className="flex justify-between items-center">
              <button type="button" onClick={handleForgot} disabled={isLoading || isLockedOut} className="text-sm text-indigo-600 hover:text-indigo-800 disabled:opacity-50">Forgot password?</button>
        ...
        {isLockedOut && (
          <div className="mt-4 p-3 rounded-lg text-sm bg-red-50 text-red-800 border border-red-200 flex items-center gap-2">
            <svg className="w-5 h-5 text-red-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m0-6v2m-6 4h12a2 2 0 002-2V9a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zM10 9h4V7a2 2 0 00-4 0v2z" />
            </svg>
            <span>
