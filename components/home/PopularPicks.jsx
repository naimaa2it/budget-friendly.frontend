      ...
      <div className="relative flex gap-6">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            className="absolute -left-4 top-1/2 transform -translate-y-1/2 z-10 bg-white rounded-full w-9 h-9 flex items-center justify-center shadow-lg hover:shadow-xl hover:border hover:border-red-600 transition-shadow"
          >
          ...
          <button
            ...
            className="absolute -right-4 top-1/2 transform -translate-y-1/2 z-10 bg-white rounded-full w-9 h-9 flex items-center justify-center shadow-lg hover:shadow-xl hover:border hover:border-red-600 transition-shadow"
          >
            <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
