...
const faqs = [
  {
    ...
    a: "Once your order ships, you will receive a tracking link by email. You can also check your order status in your account dashboard.",
  },
  {
    q: "Can I change or cancel my order?",
    a: "Orders can be changed or cancelled within 1 hour of placement. After that, the order enters processing and cannot be modified.",
  },
  {
    q: "Are the products authentic?",
    a: "Yes. We only source products from authorised distributors and verified suppliers.",
  },
  {
  ...
  },
  {
    ...
    a: "Currently we only ship within Bangladesh. International shipping is planned for the future.",
  },
];
