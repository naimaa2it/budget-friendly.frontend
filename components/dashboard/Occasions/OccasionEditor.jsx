...
export default function OccasionEditor({ sectionId = null, onSuccess, onCancel }) {
  ...
  const addCard = () => setCards(prev => [...prev, { ...EMPTY_CARD, image: { url: '', public_id: '' } }]);
  ...
  const handleCardImageUpload = async (idx, file) => {
    ...
    updateCard(idx, 'image', { url: previewUrl, public_id: '', __uploading: true });
    ...
    try {
      ...
      updateCard(idx, 'image', { url: body.asset.url, public_id: body.asset.public_id });
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow p-6 space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-gray-700">Cards ({cards.length})</h3>
          <button
            onClick={addCard}
            ...
            <div key={idx} className="border border-gray-200 rounded-xl p-4 bg-gray-50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs font-medium text-gray-600">Category Label *</label>
                    <input
                      value={card.label}
                  ...
                  <div className="sm:col-span-2">
                    <label className="text-xs font-medium text-gray-600">Subtitle / Offer text</label>
                    <input
                      value={card.subtitle}
