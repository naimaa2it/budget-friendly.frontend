  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 rounded shadow">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        ...
        <div>
          <button onClick={() => router.push('/dashboard/authorized')} className="px-3 py-2 border rounded text-sm shrink-0">Back</button>
        </div>
      </div>
      ...
      {loading ? <div className="text-center py-12">Loading…</div> : (
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => router.push('/dashboard/authorized')} className="px-3 py-2 border rounded">Cancel</button>
          </div>
        </div>
      )}
    </div>
