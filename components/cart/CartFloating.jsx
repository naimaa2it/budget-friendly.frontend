...
export default function CartFloating() {
  ...
  return (
    <button
      ...
      className="fixed right-4 top-1/2 transform -translate-y-1/2 flex items-center gap-2 bg-[#1a1a2e] text-white px-4 py-2 rounded-l-lg shadow-lg z-50 hover:bg-[#16162a] transition"
    >
