  ...
  return (
    <div className={`inline-block relative ${className}`}>      
      <select
        ...
        className="block appearance-none w-full bg-white border border-rose-300 hover:border-rose-400 px-3 py-2 pr-8 rounded leading-tight focus:outline-none focus:ring-1 focus:ring-rose-300"
      >
        {options.map(opt => (
