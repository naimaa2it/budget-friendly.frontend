...
export default function AdminLogin() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-12 p-6 bg-white rounded shadow">
      ...
      {message && (
        <div
          className={`mt-4 p-3 rounded-lg text-sm ${type === "success" ? "bg-green-50 text-green-800 border border-green-200" : type === "info" ? "bg-blue-50 text-blue-800 border border-blue-200" : "bg-red-50 text-red-800 border border-red-200"}`}
        >
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded text-sm text-gray-700">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            ...
            <strong>Admin collection</strong> (not mixed with regular users)
          </li>
