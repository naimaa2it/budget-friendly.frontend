export const metadata = { title: 'Terms & Conditions – YourHaat' };
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
        <p>By using YourHaat you agree to these terms. Please read them carefully.</p>
        <section>
        ...
        <section>
          ...
          <p>All content on this site (logos, images, text) is owned by YourHaat and may not be reproduced without written permission.</p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-gray-800 mb-1">Limitation of Liability</h2>
          <p>YourHaat is not liable for indirect or consequential damages arising from use of the site or products purchased.</p>
        </section>
      </div>
    </main>
  );
