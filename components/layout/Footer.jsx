...
export default function Footer() {
  ...
  const { storeName, storeEmail, storePhone, storeAddress } = useStoreSettings();
              ...
              <ul className="mt-4 space-y-1.5 text-sm text-[#202020]">
                {storePhone && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={`tel:${storePhone}`} className="hover:text-red-600">{storePhone}</a>
                  </li>
                )}
                {storeEmail && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={`mailto:${storeEmail}`} className="hover:text-red-600">{storeEmail}</a>
                  </li>
                )}
                {storeAddress && (
